...
$list_title = '';
if(isset($_GET['list_title'])){
    $list_title = $_GET['list_title'];
}


$read = $database->insertIntoReading($nickname, $title, $list_title);
...
<div>
<?php if ($read){
    echo "You can read a Book! Have Fun! ";
}
else{
    echo "Unfortunately book is not available!";
}
